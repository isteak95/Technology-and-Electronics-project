    ...
    return (
        <div>
            <div className="carousel w-full ">
                ...
                <img className="w-full h-[900px]" src="https://i.ibb.co/6g78ZGV/images-1.jpg" alt="images-1" border="0"/>                </div>
                <div id="item2" className="carousel-item w-full ">
                <img className="w-full h-[900px]" src="https://i.ibb.co/0j35Ygq/images-2.jpg" alt="images-2" border="0"/>                </div>
